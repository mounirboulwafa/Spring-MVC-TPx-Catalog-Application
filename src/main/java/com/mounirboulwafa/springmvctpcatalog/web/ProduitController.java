...
//        model.addAttribute("listProduits", produits);
        ...
        Page<Produit> pageProduits = produitRepository.chercher("%" + mc + "%", PageRequest.of(p, s));  //Results in Pages
    ...
    public String delete(Long id, String motCle, int page, int size) {
        ...
        return "redirect:/user/index?page=" + page + "&size=" + size + "&motCle=" + motCle;       //Delete product then redirect to index.html
    }
